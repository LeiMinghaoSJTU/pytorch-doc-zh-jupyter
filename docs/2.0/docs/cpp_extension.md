...
>
> 项目地址：<https://pytorch.apachecn.org/2.0/docs/cpp_extension>
>
> 原始地址：<https://pytorch.org/docs/stable/cpp_extension.html>
...
，以防遇到任何问题。
 ...
 如果 [ninja](https://ninja-build.org/) 构建系统在系统上不可用，则引发 `RuntimeError`，否则不执行任何操作。
 ...
 ( ) [[source]](_modules/torch/utils/cpp_extension.html#is_ninja_available)[¶](#torch.utils.cpp_extension.is_ninja_available "此定义的永久链接")


 如果 [ninja](https://ninja-build.org/) 构建系统在系统上可用，则返回“True”，否则返回“False”。